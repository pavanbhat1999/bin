...
export DBUS_SESSION_BUS_ADDRESS=unix:path=/run/user/1000/bus
 ...
 image_url=$(curl https://wallhaven.cc/api/v1/search\?q\=anime\&sorting\=random\&atleast\&resolutions\=1920x1080 | jq '.' | grep -Eoh "https:\/\/w.wallhaven.cc\/full\/.*(jpg|png)\b" | head -1)
